type BudgetStatus = "over" | "critical" | "ahead" | "warning" | "on_track"

function getBudgetStatus(percentSpent: number, dayOfMonth?: number, daysInMonth?: number): BudgetStatus {
...
export function getBudgetStatusColor(percentSpent: number, dayOfMonth?: number, daysInMonth?: number): string {
  return statusTextColors[getBudgetStatus(percentSpent, dayOfMonth, daysInMonth)]
}
...
export function getBudgetProgressBarColor(percentSpent: number, dayOfMonth?: number, daysInMonth?: number): string {
  return progressBarColors[getBudgetStatus(percentSpent, dayOfMonth, daysInMonth)]
}
...
export function getBudgetStatusLabel(percentSpent: number, dayOfMonth?: number, daysInMonth?: number): string {
  return statusLabels[getBudgetStatus(percentSpent, dayOfMonth, daysInMonth)]
}
...
export function getBudgetStatusTheme(percentSpent: number, dayOfMonth?: number, daysInMonth?: number): BudgetStatusTheme {
  return statusThemes[getBudgetStatus(percentSpent, dayOfMonth, daysInMonth)]
}
