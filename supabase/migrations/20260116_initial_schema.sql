...
WITH category_months AS (
  -- All category+month combinations from allocations
  SELECT household_id, category_id, budget_month
  FROM budget_allocations
  UNION
  -- Plus category+month combinations from expenses (catches unallocated spending)
...
-- SAVE BUDGET RPC
-- ============================================================================
-- Atomically saves all budget allocations for a month: upserts non-zero
-- amounts and deletes zeroed-out allocations in a single transaction
